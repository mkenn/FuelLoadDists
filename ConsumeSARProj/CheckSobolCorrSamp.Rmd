...
Now we will try FOFEM.<!-- First let's test the FOFEM I/O and system call

```{r fofemTry1}
# here is the header for the fofem input
# Start with the switch: #1k-SizeClass
##Stand	Litter_tpa	1hr 	10hr	10FM	100hr	3sound 6sound 9sound 20sound 3rotten 6rotten 9rotten 20rotten  	1000FM	Duff_tpa	DuffFM	DuffDepth	Herb	Shrub	Foliage	Branch	%Burn	Region	Group	Season	Category
...
# These are all lb/ac
# so, results.fofem.sa[,responseS.vars] wuold give the fofem outputs for those variables
# results.fofem.sa[,responseS.vars[1]] gives the vector of values for COS
...
Note: we're getting a warning that no ignition simulated for some of the stands. Need to look into that. 
