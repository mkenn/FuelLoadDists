...
loading.tally.fn<-function(data.file,start.col,cur.cols=c(start.col:ncol(data.file)),write.file=FALSE,file.name="LoadingTally.csv",show.plot=FALSE,plot.name="LoadingTallyGraph.pdf")
{
